 ...
 * correlations, etc). Propagation will happen through [io.opentelemetry.context.Context], from
...
interface ContextPropagators {
     ...
     */
    val textMapPropagator: io.opentelemetry.context.propagation.TextMapPropagator
