...
import io.opentelemetry.semconv.resource.attributes.ResourceAttributes.TELEMETRY_SDK_LANGUAGE
import io.opentelemetry.semconv.resource.attributes.ResourceAttributes.TELEMETRY_SDK_NAME
import io.opentelemetry.semconv.resource.attributes.ResourceAttributes.TELEMETRY_SDK_VERSION
...
abstract class Resource internal constructor() {
     ...
     * @since 1.1.0
     */
    fun toBuilder(): io.opentelemetry.sdk.resources.ResourceBuilder {
