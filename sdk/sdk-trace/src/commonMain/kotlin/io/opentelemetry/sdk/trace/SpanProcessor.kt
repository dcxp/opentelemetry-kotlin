...
interface SpanProcessor : Closeable {
    /**
     * Called when a [io.opentelemetry.api.trace.Span] is started, if the [ ][Span.isRecording]
     * returns true.
     *
    ...
    /**
     * Called when a [io.opentelemetry.api.trace.Span] is ended, if the [ ][Span.isRecording]
     * returns true.
     *
     * This method is called synchronously on the execution thread, should not throw or block the
     * execution thread.
