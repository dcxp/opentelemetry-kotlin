...
/**
 * Immutable representation of all data collected by the [io.opentelemetry.api.trace.Span] class.
 */
interface SpanData {
    /**
     ...
     * @return the `Status`.
     */
    val status: io.opentelemetry.sdk.trace.data.StatusData
     ...
     */
    val events: List<io.opentelemetry.sdk.trace.data.EventData>
     ...
     */
    val links: List<io.opentelemetry.sdk.trace.data.LinkData>
