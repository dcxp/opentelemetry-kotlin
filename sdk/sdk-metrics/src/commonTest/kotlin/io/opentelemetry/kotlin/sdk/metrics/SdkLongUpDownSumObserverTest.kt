...
/** Unit tests for [LongUpDownSumObserverSdk]. */
internal class SdkLongUpDownSumObserverTest {
    ...
    fun collectMetrics_NoRecords() {
        ...
        sdkMeterProvider[SdkLongUpDownSumObserverTest::class.simpleName!!]
    ...
    fun collectMetrics_WithOneRecord() {
        val sdkMeterReader = InMemoryMetricReader.create()
        val sdkMeterProvider = sdkMeterProviderBuilder.registerMetricReader(sdkMeterReader).build()
        sdkMeterProvider[SdkLongUpDownSumObserverTest::class.simpleName!!].upDownCounterBuilder(
                "testObserver"
            )
    ...
    companion object {
        ...
        private val INSTRUMENTATION_LIBRARY_INFO =
            InstrumentationLibraryInfo.create(
                SdkLongUpDownSumObserverTest::class.simpleName!!,
                null
            )
    }
}
