...
interface Span : ImplicitContextKeyed {
     ...
     * @return this.
     */
    fun setStatus(statusCode: io.opentelemetry.api.trace.StatusCode): Span {
     ...
     * @return this.
     */
    fun setStatus(statusCode: io.opentelemetry.api.trace.StatusCode, description: String): Span
    /**
